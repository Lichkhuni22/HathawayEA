...
byte i = 0;
byte ii = 0;
byte brightness = 10;//20//80   20//100//150//10
bool flag = true;
bool flag1 = true;
bool LEFT = true;
bool YIELD = true;
...
unsigned long previousYieldMillis = 0;
...
//eye16
static const byte screen_1_eye_16[] = {176,177,178,179,192,203,204,205,210,211,212,213,222,225,234,235,236,237,245,254};
byte screen_1_eye_16_size = sizeof(screen_1_eye_16) / sizeof(byte);
static const byte screen_2_eye_16[] = {191,193,221,226,253};
byte screen_2_eye_16_size = sizeof(screen_2_eye_16) / sizeof(byte);
static const byte screen_3_eye_16[] = {0,11,16,17,18,19};
byte screen_3_eye_16_size = sizeof(screen_3_eye_16) / sizeof(byte);
static const byte screen_4_eye_16[] = {1,31};
byte screen_4_eye_16_size = sizeof(screen_4_eye_16) / sizeof(byte);
static const byte screen_5_eye_16[] = {112,113,114,115,116,122,134,137,138,139,140,147,148,149,150,154,155,156,160,161,162,163,164};
byte screen_5_eye_16_size = sizeof(screen_5_eye_16) / sizeof(byte);
//eye17
static const byte screen_1_eye_17[] = {204,205,206,207,210,211,212,223,225,234,235,236,237,244,255};
byte screen_1_eye_17_size = sizeof(screen_1_eye_17) / sizeof(byte);
static const byte screen_2_eye_17[] = {192,222,226,254};
byte screen_2_eye_17_size = sizeof(screen_2_eye_17) / sizeof(byte);
static const byte screen_3_eye_17[] = {12,13,14,15};
byte screen_3_eye_17_size = sizeof(screen_3_eye_17) / sizeof(byte);
static const byte screen_4_eye_17[] = {0};
byte screen_4_eye_17_size = sizeof(screen_4_eye_17) / sizeof(byte);
static const byte screen_5_eye_17[] = {123,124,125,126,127,133,137,138,139,140,147,148,149,155,156,157,158,159};
byte screen_5_eye_17_size = sizeof(screen_5_eye_17) / sizeof(byte);
//eye18
static const byte screen_1_eye_18[] = {224,235,236,237,238,239};
byte screen_1_eye_18_size = sizeof(screen_1_eye_18) / sizeof(byte);
static const byte screen_2_eye_18[] = {224,225};
byte screen_2_eye_18_size = sizeof(screen_2_eye_18) / sizeof(byte);
static const byte screen_5_eye_18[] = {138,139,140,141,142,143};
byte screen_5_eye_18_size = sizeof(screen_5_eye_18) / sizeof(byte);
//eye19
static const byte screen_1_eye_19[] = {224,235,244,255};
byte screen_1_eye_19_size = sizeof(screen_1_eye_19) / sizeof(byte);
static const byte screen_2_eye_19[] = {225,254};
byte screen_2_eye_19_size = sizeof(screen_2_eye_19) / sizeof(byte);
static const byte screen_3_eye_19[] = {12,13,14,15};
byte screen_3_eye_19_size = sizeof(screen_3_eye_19) / sizeof(byte);
static const byte screen_4_eye_19[] = {0};
byte screen_4_eye_19_size = sizeof(screen_4_eye_19) / sizeof(byte);
static const byte screen_5_eye_19[] = {123,124,125,126,127,133,137,138};
byte screen_5_eye_19_size = sizeof(screen_5_eye_19) / sizeof(byte);
//eye20
static const byte screen_1_eye_20[] = {207,209,237,241};
byte screen_1_eye_20_size = sizeof(screen_1_eye_20) / sizeof(byte);
static const byte screen_2_eye_20[] = {192,193,194,195,208,219,220,221,226,227,228,229,238,240,251};
byte screen_2_eye_20_size = sizeof(screen_2_eye_20) / sizeof(byte);
static const byte screen_3_eye_20[] = {15};
byte screen_3_eye_20_size = sizeof(screen_3_eye_20) / sizeof(byte);
static const byte screen_4_eye_20[] = {0,1,2,3};
byte screen_4_eye_20_size = sizeof(screen_4_eye_20) / sizeof(byte);
static const byte screen_6_eye_20[] = {96,97,98,99,100,106,107,108,115,116,117,118,122,128,129,130,131,132};
byte screen_6_eye_20_size = sizeof(screen_6_eye_20) / sizeof(byte);

//eye21
static const byte screen_1_eye_21[] = {238,239};
byte screen_1_eye_21_size = sizeof(screen_1_eye_21) / sizeof(byte);
static const byte screen_2_eye_21[] = {224,225,226,227,228,239};
byte screen_2_eye_21_size = sizeof(screen_2_eye_21) / sizeof(byte);
static const byte screen_6_eye_21[] = {112,113,114,115,116,117};
byte screen_6_eye_21_size = sizeof(screen_6_eye_21) / sizeof(byte);

//eye22
static const byte screen_1_eye_22[] = {238,241};
byte screen_1_eye_22_size = sizeof(screen_1_eye_22) / sizeof(byte);
static const byte screen_2_eye_22[] = {228,239,240,251};
byte screen_2_eye_22_size = sizeof(screen_2_eye_22) / sizeof(byte);
static const byte screen_3_eye_22[] = {15};
byte screen_3_eye_22_size = sizeof(screen_3_eye_22) / sizeof(byte);
static const byte screen_4_eye_22[] = {0,1,2,3};
byte screen_4_eye_22_size = sizeof(screen_4_eye_22) / sizeof(byte);
static const byte screen_6_eye_22[] = {117,122,128,129,130,131,132};
byte screen_6_eye_22_size = sizeof(screen_6_eye_22) / sizeof(byte);

//smile mouth whole screen 1
static const byte screen_1_mouth_6[] = {172,173,174,175,176,177,178,179,180,181,182,183,197,198,199,200,201,202,203,204,205,206,207,216,217,218,219,220,221,224,225,226,227,228,254,255};
byte screen_1_mouth_6_size = sizeof(screen_1_mouth_6) / sizeof(byte);
static const byte screen_2_mouth_6[] = {160,161,162,163,184,185,186,187,188,189,190,191,192,193,194,195,196,197,198,199,200,201,202,210,211,212,213,214,215,235,236,237,238,239,240,241};
byte screen_2_mouth_6_size = sizeof(screen_2_mouth_6) / sizeof(byte);
static const byte screen_5_mouth_6[] = {70,71,72,73,85,86,87,88,89,90,100,101,102,106,107,108,114,115,116,124,125,126,127,128,129};
byte screen_5_mouth_6_size = sizeof(screen_5_mouth_6) / sizeof(byte);
static const byte screen_6_mouth_6[] = {126,127,128,129,130,131,139,140,141,147,148,149,153,154,155,165,166,167,168,169,170,182,183,184,185};
byte screen_6_mouth_6_size = sizeof(screen_6_mouth_6) / sizeof(byte);




//smile mouth whole screen 2
static const byte screen_1_mouth_7[] = {172,173,174,175,176,177,178,179,180,181,182,183,197,198,199,200,201,202,203,204,205,206,207,216,217,218,219,220,225,226,227,228,254,255};
byte screen_1_mouth_7_size = sizeof(screen_1_mouth_7) / sizeof(byte);
static const byte screen_2_mouth_7[] = {160,161,162,163,184,185,186,187,188,189,190,191,192,193,194,195,196,197,198,199,200,201,202,211,212,213,214,215,234,235,236,237,238,240,241};
byte screen_2_mouth_7_size = sizeof(screen_2_mouth_7) / sizeof(byte);
static const byte screen_5_mouth_7[] = {86,87,88,89,101,102,106,107,114,115,116,125,126,127,128};
byte screen_5_mouth_7_size = sizeof(screen_5_mouth_7) / sizeof(byte);
static const byte screen_6_mouth_7[] = {127,128,129,130,139,140,141,148,149,153,154,166,167,168,169};
byte screen_6_mouth_7_size = sizeof(screen_6_mouth_7) / sizeof(byte);

//smile mouth 8
static const byte screen_1_mouth_8[] = {16,17,18,42,43,44,45,46,47,52,53,54,72,73,86,87};
byte screen_1_mouth_8_size = sizeof(screen_1_mouth_8) / sizeof(byte);
static const byte screen_2_mouth_8[] = {29,30,31,32,33,34,35,36,37,57,58,59,70,71,88,89};
byte screen_2_mouth_8_size = sizeof(screen_2_mouth_8) / sizeof(byte);

//static const byte screen_1_text_9[] = {};
//byte screen_1_text_9_size = sizeof(screen_1_text_9) / sizeof(byte);
//static const byte screen_2_text_9[] = {};
//byte screen_2_text_9_size = sizeof(screen_2_text_9) / sizeof(byte);

/*
static const byte screen_1_text_3[] = {};
byte screen_1_text_3_size = sizeof(screen_1_text_3) / sizeof(byte);
static const byte screen_2_text_3[] = {};
byte screen_2_text_3_size = sizeof(screen_2_text_3) / sizeof(byte);
static const byte screen_5_text_3[] = {};
byte screen_5_text_3_size = sizeof(screen_5_text_3) / sizeof(byte);
static const byte screen_6_text_3[] = {};
byte screen_6_text_3_size = sizeof(screen_6_text_3) / sizeof(byte);

static const byte screen_1_bubble_1[] = {};
byte screen_1_bubble_1_size = sizeof(screen_1_bubble_1) / sizeof(byte);
static const byte screen_2_bubble_1[] = {};
byte screen_2_bubble_1_size = sizeof(screen_2_bubble_1) / sizeof(byte);
static const byte screen_3_bubble_1[] = {};
byte screen_3_bubble_1_size = sizeof(screen_3_bubble_1) / sizeof(byte);
static const byte screen_4_bubble_1[] = {};
byte screen_4_bubble_1_size = sizeof(screen_4_bubble_1) / sizeof(byte);
static const byte screen_5_bubble_1[] = {};
byte screen_5_bubble_1_size = sizeof(screen_5_bubble_1) / sizeof(byte);
static const byte screen_6_bubble_1[] = {};
byte screen_6_bubble_1_size = sizeof(screen_6_bubble_1) / sizeof(byte);
*/
...
////            delay(1*DELAY);
//////            leds[i] = CRGB::Black;
//////            leds[143-i] = CRGB::Black;
//////            FastLED.show();
////            i++;
////            //Serial.println(i);
////            if(i==67){//139//66//72-5//67//30for150
////              delay(2000);
////              flag=false;
////            }
////          }
...
void eye1On(){
  ...
  for(int j=0;j<screen_4_eye_1_size;j++){
    leds4[screen_4_eye_1[j]] = CRGB(255,0,190);//cyan
  }
}
...
void eye6Off(){
  for(int j=0;j<screen_1_eye_6_size;j++){
    leds1[screen_1_eye_6[j]] = CRGB::Black;//cyan 150
  }
  for(int j=0;j<screen_2_eye_6_size;j++){
    leds2[screen_2_eye_6[j]] = CRGB::Black;//cyan 150
  }
  for(int j=0;j<screen_3_eye_6_size;j++){
    leds3[screen_3_eye_6[j]] = CRGB::Black;//cyan 150
  }
  for(int j=0;j<screen_4_eye_6_size;j++){
    leds4[screen_4_eye_6[j]] = CRGB::Black;//cyan 150
  }
  for(int j=0;j<screen_5_eye_6_size;j++){
    leds5[screen_5_eye_6[j]] = CRGB::Black;//cyan
  }
}
...
//  }
//  for(int j=0;j<screen_5_bubble_1_size;j++){
//    leds6[screen_5_bubble_1[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan 150
//  }
//  for(int j=0;j<screen_6_bubble_1_size;j++){
//    leds5[screen_6_bubble_1[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan 150
//  }
}
void rightSpeakOn(){
  bubble1On();
...
void mouth6On(){
  for(int j=0;j<screen_1_mouth_6_size;j++){
    leds1[screen_1_mouth_6[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_2_mouth_6_size;j++){
    leds2[screen_2_mouth_6[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_5_mouth_6_size;j++){
    leds5[screen_5_mouth_6[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
  for(int j=0;j<screen_6_mouth_6_size;j++){
    leds6[screen_6_mouth_6[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
}
void mouth7On(){
  for(int j=0;j<screen_1_mouth_7_size;j++){
    leds1[screen_1_mouth_7[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_2_mouth_7_size;j++){
    leds2[screen_2_mouth_7[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_5_mouth_7_size;j++){
    leds5[screen_5_mouth_7[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
  for(int j=0;j<screen_6_mouth_7_size;j++){
    leds6[screen_6_mouth_7[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
}
void eye14On(){
...
void eye16On(){
  for(int j=0;j<screen_1_eye_16_size;j++){
    leds1[screen_1_eye_16[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_2_eye_16_size;j++){
    leds2[screen_2_eye_16[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_3_eye_16_size;j++){
    leds3[screen_3_eye_16[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_4_eye_16_size;j++){
    leds4[screen_4_eye_16[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan 150
  }
  for(int j=0;j<screen_5_eye_16_size;j++){
    leds5[screen_5_eye_16[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
}
void eye17On(){
  for(int j=0;j<screen_1_eye_17_size;j++){
    leds1[screen_1_eye_17[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_2_eye_17_size;j++){
    leds2[screen_2_eye_17[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_3_eye_17_size;j++){
    leds3[screen_3_eye_17[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_4_eye_17_size;j++){
    leds4[screen_4_eye_17[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan 150
  }
  for(int j=0;j<screen_5_eye_17_size;j++){
    leds5[screen_5_eye_17[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
}
void eye18On(){
  for(int j=0;j<screen_1_eye_18_size;j++){
    leds1[screen_1_eye_18[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_2_eye_18_size;j++){
    leds2[screen_2_eye_18[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_5_eye_18_size;j++){
    leds5[screen_5_eye_18[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
}
void eye19On(){
  for(int j=0;j<screen_1_eye_19_size;j++){
    leds1[screen_1_eye_19[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_2_eye_19_size;j++){
    leds2[screen_2_eye_19[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_3_eye_19_size;j++){
    leds3[screen_3_eye_19[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_4_eye_19_size;j++){
    leds4[screen_4_eye_19[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan 150
  }
  for(int j=0;j<screen_5_eye_19_size;j++){
    leds5[screen_5_eye_19[j]] = CRGB(255,0,SCREEN_TYPE_2);//cyan
  }
}

void mouth8On(){
  for(int j=0;j<screen_1_mouth_8_size;j++){
    leds1[screen_1_mouth_8[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
  for(int j=0;j<screen_2_mouth_8_size;j++){
    leds2[screen_2_mouth_8[j]] = CRGB(255,0,SCREEN_TYPE_1);//cyan 150
  }
}
...
//  for(int j=0;j<screen_1_text_2_size;j++){
//    leds1[screen_1_text_2[j]] = CRGB(255,0,255);//cyan
//  }
  for(int j=0;j<screen_2_text_3_size;j++){
    leds2[screen_2_text_3[j]] = CRGB(255,0,255);//cyan
  }
//  for(int j=0;j<screen_2_text_2_size;j++){
//    leds2[screen_2_text_2[j]] = CRGB(255,0,255);//cyan
//  }
  ...
  for(int j=0;j<screen_5_text_3_size;j++){
    leds5[screen_5_text_3[j]] = CRGB(255,0,190);//cyan 255，0，190
  }
  for(int j=0;j<screen_6_text_3_size;j++){
    leds6[screen_6_text_3[j]] = CRGB(255,0,190);//cyan
  }
}
//void text4On(){
//  for(int j=0;j<screen_1_text_4_size;j++){
//    leds1[screen_1_text_4[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_1_text_11_size;j++){//2
//    leds1[screen_1_text_11[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_2_text_4_size;j++){
//    leds2[screen_2_text_4[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_2_text_11_size;j++){
//    leds2[screen_2_text_11[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_3_eye_2_size;j++){
//    leds3[screen_3_eye_2[j]] = CRGB(255,0,255);//cyan 150
//  }
//  for(int j=0;j<screen_4_eye_2_size;j++){
//    leds4[screen_4_eye_2[j]] = CRGB(255,0,170);//cyan
//  }
//  for(int j=0;j<screen_5_text_4_size;j++){
//    leds5[screen_5_text_4[j]] = CRGB(255,0,170);//cyan 255，0，190
//  }
//  for(int j=0;j<screen_6_text_4_size;j++){
//    leds6[screen_6_text_4[j]] = CRGB(255,0,170);//cyan
//  }
//}
//void text6On(){
//  for(int j=0;j<screen_1_text_6_size;j++){
//    leds1[screen_1_text_6[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_1_text_7_size;j++){
//    leds1[screen_1_text_7[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_2_text_6_size;j++){
//    leds2[screen_2_text_6[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_2_text_7_size;j++){
//    leds2[screen_2_text_7[j]] = CRGB(255,0,255);//cyan
//  }
//  for(int j=0;j<screen_3_eye_1_size;j++){
//    leds3[screen_3_eye_1[j]] = CRGB(255,0,255);//cyan 150
//  }
//  for(int j=0;j<screen_4_eye_1_size;j++){
//    leds4[screen_4_eye_1[j]] = CRGB(255,0,170);//cyan
//  }
//}
void text8On(){
  for(int j=0;j<screen_1_mouth_1_size;j++){
...
//  for(int j=0;j<screen_5_sign_1_size;j++){
//    leds5[screen_5_sign_1[j]] = CRGB(255,0,170);//cyan 255，0，190
//  }
//  for(int j=0;j<screen_6_sign_1_size;j++){
//    leds6[screen_6_sign_1[j]] = CRGB(255,0,170);//cyan
//  }
}
void text9On(){
...
//leds[i+16-4] = CRGB::Black;//36,30
//      leds[i+17-4] = CRGB::Black;
//      leds[i+18-4] = CRGB::Black;
//      leds[i+19-4] = CRGB::Black;
//      leds[i+20-4] = CRGB::Black;
//      leds[i+21-4] = CRGB::Black;
//      leds[i+22-4] = CRGB::Black;
//
////      FastLED.show();
//
//leds[i+16] = CRGB(255,0,255);//36,30
//      leds[i+17] = CRGB(255,0,255);
//      leds[i+18] = CRGB(255,0,255);
//      leds[i+19] = CRGB(255,0,255);
//      leds[i+20] = CRGB(255,0,255);
...
void ledMode18On(){
  ...
  if(flag1){
        ...
        if (ii < 92){//67,Mode1Size,136//100--16 32--84
leds[ii+24-4] = CRGB::Black;//36,30
      leds[ii+25-4] = CRGB::Black;//position
      leds[ii+26-4] = CRGB::Black;//POSITION
      leds[ii+27-4] = CRGB::Black;
      leds[ii+28-4] = CRGB::Black;
      leds[ii+29-4] = CRGB::Black;
      leds[ii+30-4] = CRGB::Black;



leds[ii+24] = CRGB(255,0,255);//36,30
      leds[ii+25] = CRGB(255,0,255);
      leds[ii+26] = CRGB(255,0,255);
      leds[ii+27] = CRGB(255,0,255);
      leds[ii+28] = CRGB(255,0,255);
      leds[ii+29] = CRGB(255,0,255);
      leds[ii+30] = CRGB(255,0,255);
      ...
      ii=ii+4;//SPEED 4
      //Serial.println(i);
      if(ii==92){//139//66//72-5//67//65//==100>100
        //rightBlinking();
        flag1=false;
      }
    }
